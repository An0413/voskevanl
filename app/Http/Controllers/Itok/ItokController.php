...
class ItokController extends Controller
{
    public function __invoke()
    {
        ...
        $imagesg1 = Images::where('gallery_id', '=', 50)->where('status', '=', 1)->get();
        ...
        $info = Main_info::where('menu_id', '=', 5)->where('status', '=', 1)->get();
        $services = Services::all();

        return view('itok.itok', compact('worker',  'imagesg', 'imagesg1', 'images0', 'services', 'info'));
    }
}
