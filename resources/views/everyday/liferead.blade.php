            ...
            <div class="row no-gutters">
                <div class="content col-xl-9 d-flex align-items-stretch aos-init aos-animate">
                        <div class="row newsstyle">
                            ...
                            <div class="col-4 mt-5">
                                <img src="{{asset('assets/img/gallery/' .$value->img)}}" class="w-100"
                ...
                <div class="col-xl-3">
                    @foreach($recent_news as $value)
                        <div class="row mt_2r">
                            <div class="col-4">
                                <img src="{{asset('assets/img/gallery/' .$value->img)}}" class="img_w_100">
                            </div>
                            <div class="col-8">
...
<div class="modal fade" id="comment" tabindex="-1" aria-labelledby="comment" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('commentevery_store', $news_id)}}" method="POST" enctype="multipart/form-data">
                @csrf
