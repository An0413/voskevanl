    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <form action="{{ route('everyday_update', $news->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="mb-3 mt-3 w-50">
                    ...
                    <div>
                        <img src="{{asset('assets/img/gallery/'.$news->img) }}" style="width: 150px; height: 150px;">
                    </div>
                <div>
