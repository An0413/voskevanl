                        ...
                        @csrf
                            <div class="row">
                                <div class="col-4">
                                    <div class="card-body w-100">
                                        <div class="form-group">
                                            <label for="name">Լուսանկար - <img src="{{asset('assets/img/sights/'. $sights->image)}}"
                                                                               style="width: 90px; height: 90px; object-fit: cover"></label>
                                        </div>
                                        <div class="form-group">
                                            <label for="seq">Վերնագիր - {{$sights->name}} </label>
                                        </div>
                                        <div class="form-group">
                                            @php
                                                $user_info = App\Helper::getUserInfo($sights->user_id);
                                            @endphp
                                ...
                                <div class="col-4">
                                    <div class="card-body w-100">
                                        <div class="form-group">
                                            <label for="name">Նկարագրություն - {{$sights->description}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
